// ================================================================================================
// entrypoints/main.content/uiSetups/pageSettings.ts
...
export const setupPageSettingsSetter = async (container: HTMLDivElement) => {
    // ==== 問題文から設定値を取得してUIに反映する ====
    // 反映先のDOM要素を取得
    const settingsElement = {
        testTimeLimit: container.querySelector<HTMLInputElement>("#input-settings-test-time-limit"),
        allowableError: container.querySelector<HTMLInputElement>("#input-settings-allowable-error"),
    };
    // 問題文から設定値を取得
    const settingsValue = {
        testTimeLimit: (() => {

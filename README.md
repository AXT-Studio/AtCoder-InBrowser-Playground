...
```bash
# Chrome向けビルド
pnpm --filter atcoder-inbrowser-playground build
# Firefox向けビルド
pnpm --filter atcoder-inbrowser-playground build:firefox
# Chrome向け ビルド→Zip化
pnpm --filter atcoder-inbrowser-playground zip
# Firefox向け ビルド→Zip化
pnpm --filter atcoder-inbrowser-playground zip:firefox
```
